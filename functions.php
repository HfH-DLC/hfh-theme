...
{
	wp_enqueue_style('hfh-theme-style', get_stylesheet_uri(), array(), _S_VERSION);
	wp_style_add_data('hfh-theme-style', 'rtl', 'replace');

	wp_enqueue_style('hfh-theme-style-index', get_template_directory_uri() . '/css/index.css', array(), _S_VERSION);

	wp_enqueue_script('hfh-theme-navigation', get_template_directory_uri() . '/js/navigation.js', array(), _S_VERSION, true);

	wp_enqueue_script('hfh-theme-site-search', get_template_directory_uri() . '/js/site-search.js', array('jquery'), _S_VERSION, true);
