...
<div class="hfh-single-navigation hfh-w-container">
    <?php if ($hfh_theme_previous_post) : ?>
        <hfh-link class="hfh-single-navigation__link hfh-single-navigation__link--previous" href='<?= esc_url(get_the_permalink($hfh_theme_previous_post)) ?>'><hfh-arrow-icon></hfh-arrow-icon><?= __('Previous Post', 'hfh-theme') ?></hfh-link>
    <?php
    endif;
